...
app.post("/api/getMatch", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getMatch", req.body)
...
app.post("/api/getMatches", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getMatches", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getMatchesStats", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getMatchesStats", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getMatchStats", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getMatchStats", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getMatchMapStats", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getMatchMapStats", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getStreams", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getStreams", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getRecentThreads", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getRecentThreads", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getTeamRanking", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getTeamRanking", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getTeam", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getTeam", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getTeamByName", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getTeamByName", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getTeamStats", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getTeamStats", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getPlayer", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getPlayer", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getPlayerByName", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getPlayerByName", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getPlayerStats", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getPlayerStats", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getPlayerRanking", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getPlayerRanking", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getEvents", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getEvents", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getEvent", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getEvent", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
...
app.post("/api/getEventByName", async (req, res) => {
	try {
		...
		var errorId = await reportError(err, "getEventByName", req.body)
		res.status(400).send({error: err.toString(), id: errorId})
	}
})
